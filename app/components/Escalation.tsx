...
export default function Escalation() {
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-neutral-bg dark:bg-dark-bg">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 dark:text-dark-text-primary mb-6">
            ...
            <p className="text-lg font-semibold text-gray-900 dark:text-dark-text-primary mb-4">
              You&apos;re instantly alerted in chat whenever:
            </p>
            <ul className="space-y-3 text-gray-600 dark:text-dark-text-secondary mb-8">
              <li className="flex items-start gap-2">
                <span className="text-accent dark:text-dark-accent-primary mt-1">•</span>
            ...
            <p className="text-lg text-gray-700 dark:text-dark-text-primary font-medium">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="bg-white dark:bg-dark-surface rounded-2xl p-8 shadow-xl border border-gray-100 dark:border-dark-border">
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 bg-gray-50 dark:bg-dark-surface rounded-lg p-4">
                ...
                <div className="flex items-start gap-4 justify-end">
                  <div className="flex-1 bg-accent dark:bg-dark-accent-primary text-white dark:text-white rounded-lg p-4 text-sm">
