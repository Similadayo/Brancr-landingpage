...
export default function CTA() {
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-900 via-primary-dark to-gray-900 dark:from-gray-800 dark:via-primary-dark dark:to-gray-800">
