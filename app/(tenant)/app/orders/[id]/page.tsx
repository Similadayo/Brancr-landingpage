    ...
    return (
      <div className="rounded-xl border-2 border-rose-200 bg-rose-50 p-8 text-center">
        ...
        <button
          ...
          className="mt-4 inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-2 text-sm font-semibold text-white transition hover:bg-primary/90 dark:bg-white dark:text-gray-100 dark:hover:bg-gray-100"
        >
                ...
                <div className="space-y-3">
                  {order.status === "pending" && (
                    <button
                      ...
                      className="w-full rounded-lg bg-primary px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-primary/90 dark:bg-white dark:text-gray-100 dark:hover:bg-gray-100"
                    >
                      Confirm Payment
                    </button>
                  )}
