              ...
              <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <div className="mt-4 flex flex-wrap items-center gap-3">
                  <button
                    ...
                    className="rounded-xl bg-primary px-4 py-2 text-sm font-semibold text-white shadow transition hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-white dark:text-gray-100 dark:hover:bg-gray-100"
                  >
