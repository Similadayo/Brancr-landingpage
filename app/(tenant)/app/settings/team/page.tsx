        ...
        <div className="mx-auto max-w-7xl space-y-6">
          <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-primary/30 transition hover:bg-primary/90 dark:bg-white dark:text-gray-100 dark:hover:bg-gray-100"
            >
              Invite Member
                ...
                <form onSubmit={handleInvite} className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-2">
                    <button
                      ...
                      className="flex-1 rounded-xl bg-primary px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-primary/30 transition hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-white dark:text-gray-100 dark:hover:bg-gray-100"
                    >
