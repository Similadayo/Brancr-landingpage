              ...
              {captionStrategy === "ai_batch" && (
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-white hover:bg-primary/90 disabled:opacity-50 dark:bg-white dark:text-gray-100 dark:hover:bg-gray-100"
                  >
