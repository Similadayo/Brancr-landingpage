...
export default function TelegramConnectButton({ variant = 'inline', onSuccess }: Props) {
    ...
    return (
        <button
            onClick={handleConnect}
            disabled={loading}
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#0088cc]/10 hover:bg-[#0088cc]/20 text-[#0088cc] text-sm font-medium transition-colors disabled:opacity-50"
        >
