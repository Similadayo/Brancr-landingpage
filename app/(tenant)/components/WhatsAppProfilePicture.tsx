...
export function WhatsAppProfilePicture() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
      <h3 className="text-lg font-semibold text-gray-900 mb-4">WhatsApp Profile Picture</h3>
      ...
      <div className="space-y-4">
        ...
        {photoUrl && (
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">This is your current WhatsApp profile picture</p>
            </div>
          </div>
        )}
        ...
        {!photoUrl && !loading && (
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-medium text-gray-700">No Profile Picture</p>
              <p className="text-xs text-gray-500 mt-1">Upload a profile picture to display it here</p>
            </div>
          </div>
        )}
        ...
        <div className="space-y-2">
          <label className="block">
            <span className="text-sm font-medium text-gray-700 mb-2 block">Upload New Picture</span>
            <input
              type="file"
              accept="image/*"
              onChange={handleFileChange}
              disabled={loading}
              className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-primary file:text-white hover:file:bg-primary/90 file:cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            />
          </label>
