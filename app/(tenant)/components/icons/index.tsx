...
export const ArrowDownTrayIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    className={className}
    width={size || 20}
    height={size || 20}
...
export const PhotoIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    className={className}
    width={size || 20}
    height={size || 20}
...
export const FilmIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    className={className}
    width={size || 20}
    height={size || 20}
...
export const ShoppingBagIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    className={className}
    width={size || 20}
    height={size || 20}
...
export const CloudArrowUpIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    className={className}
    width={size || 20}
    height={size || 20}
...
export const VideoCameraIcon = ({ className = "w-5 h-5", size }: IconProps) => (
  <svg
    className={className}
    width={size || 20}
    height={size || 20}
