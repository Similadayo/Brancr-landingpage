...
const variantStyles = {
  success: 'bg-green-100 text-green-700 border-green-200 dark:bg-dark-accent-success/20 dark:text-white dark:border-dark-accent-success/50',
  warning: 'bg-amber-100 text-amber-700 border-amber-200 dark:bg-dark-accent-warning/20 dark:text-white dark:border-dark-accent-warning/50',
  error: 'bg-red-100 text-red-700 border-red-200 dark:bg-dark-accent-error/20 dark:text-white dark:border-dark-accent-error/50',
  info: 'bg-blue-100 text-blue-700 border-blue-200 dark:bg-dark-accent-primary/20 dark:text-white dark:border-dark-accent-primary/50',
